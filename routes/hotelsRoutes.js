...
const {gethoteltypes, gethotels, createhotel, updatehotel, deletehotel, hoteldetails, uploadimage, getadhotel, createhotelbook} = require('../controllers/hotelsController')
...
router.post('/book', auth, createhotelbook)
